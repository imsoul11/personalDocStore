...
type GetDocumentsHandlerFunc func(GetDocumentsParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetDocumentsHandlerFunc) Handle(params GetDocumentsParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// GetDocumentsHandler interface for that can handle valid get documents params
type GetDocumentsHandler interface {
	Handle(GetDocumentsParams, interface{}) middleware.Responder
}
