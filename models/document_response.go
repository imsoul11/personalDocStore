...
func (m *DocumentResponse) validateAcknowledgement(formats strfmt.Registry) error {
...
func (m *DocumentResponse) validateDocument(formats strfmt.Registry) error {
...
func (m *DocumentResponse) validateSuccess(formats strfmt.Registry) error {
...
func (m *DocumentResponse) contextValidateDocument(ctx context.Context, formats strfmt.Registry) error {
